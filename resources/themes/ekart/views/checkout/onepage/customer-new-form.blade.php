@if (isset($shipping) && $shipping)
    <div :class="`col-12 form-group${errors.has('address-form.shipping[first_name]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[last_name]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[email]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[address1][]') ? 'has-error' : ''}`" style="margin-bottom: 0;">
    ...
    @if (
        ...
        @for ($i = 1; $i < core()->getConfigData('customer.settings.address.street_lines'); $i++)
            <div class="col-12 form-group" style="margin-top: 10px; margin-bottom: 0">
                <input
                    class="form-control"
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[city]') ? 'has-error' : ''}`" style="margin-top: 15px;">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[country]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[state]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[postcode]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.shipping[phone]') ? 'has-error' : ''}`">
    ...
    @auth('customer')
        <div class="col-12 form-group">
            <span class="ps-checkbox h4 d-inline-block no-gutters">
                <input
                ...
                <label for="shipping[save_as_address]">
...
@elseif (isset($billing) && $billing)
    <div :class="`col-12 form-group ${errors.has('address-form.billing[company_name]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[first_name]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[last_name]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[email]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[address1][]') ? 'has-error' : ''}`" style="margin-bottom: 0;">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[city]') ? 'has-error' : ''}`" style="margin-top: 15px;">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[country]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[state]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[postcode]') ? 'has-error' : ''}`">
    ...
    <div :class="`col-12 form-group ${errors.has('address-form.billing[phone]') ? 'has-error' : ''}`">
    ...
    @auth('customer')
        <div class="col-12 form-group">
            <span class="ps-checkbox h4 d-inline-block no-gutters">
                ...
                <label for="billing[save_as_address]">
                    {{ __('shop::app.checkout.onepage.save_as_address') }}
                </label>
            </span>
        </div>
