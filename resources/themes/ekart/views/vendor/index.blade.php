                            ...
                            <div slot="body">
                                <div class="row justify-content-start">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-4" :class="[errors.has('phone') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" maxlength="15" name="phone" v-validate="'required'" value="{{ old('phone') }}">
                                    ...
                                    <div class="control-group form-group col-12" :class="[errors.has('additional_notes') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="additional_notes" v-validate="'required'" value="{{ old('additional_notes') }}">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-3" :class="[errors.has('facebook_link') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="facebook_link" v-validate="'required'" value="{{ old('facebook_link') }}">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-3" :class="[errors.has('instagram_link') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="instagram_link" v-validate="'required'" value="{{ old('instagram_link') }}">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-3" :class="[errors.has('twitter_link') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="twitter_link" v-validate="'required'" value="{{ old('twitter_link') }}">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-3" :class="[errors.has('youtube_link') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="youtube_link" v-validate="'required'" value="{{ old('youtube_link') }}">
                            ...
                            <div slot="body">
                                <div class="row justify-content-start">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-4" :class="[errors.has('owner_phone') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" maxlength="15" name="owner_phone" v-validate="'required'" value="{{ old('owner_phone') }}">
                                    ...
                                    <div class="control-group form-group col-md-6 col-lg-4" :class="[errors.has('owner_pincode') ? 'has-error' : '']">
                                        ...
                                        <input type="text" class="form-control" name="owner_pincode" v-validate="'required'" value="{{ old('owner_pincode') }}">
                            ...
                            <div slot="body">
                                <div class="row justify-content-start">
                                    <div class="control-group form-group custom-file col-md-6 col-lg-4" :class="[errors.has('gst_certificate') ? 'has-error' : '']">
                                        ...
                                        <input type="file" accept="" class="custom-file-input" name="gst_certificate" v-validate="'required'" value="{{ old('gst_certificate') }}">
                                    ...
                                    <div class="control-group form-group custom-file col-md-6 col-lg-4" :class="[errors.has('mca_certificate') ? 'has-error' : '']">
                                        ...
                                        <input type="file" accept="" class="custom-file-input" name="mca_certificate" v-validate="'required'" value="{{ old('mca_certificate') }}">
                                    ...
                                    <div class="control-group form-group custom-file col-md-6 col-lg-4" :class="[errors.has('other_certificate') ? 'has-error' : '']">
                                        ...
                                        <input type="file" accept="" class="custom-file-input" name="other_certificate" v-validate="'required'" value="{{ old('other_certificate') }}">
