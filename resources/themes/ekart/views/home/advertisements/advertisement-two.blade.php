        ...
        <div class="container-fluid advertisement-two-container">
            <div class="row">
                @if ( isset($advertisementTwo[0]))
                    <a @if ($links[1]!='') target="_blank" href="{{ $links[1] }}" @endif class="col-lg-9 col-md-12 no-padding">
                        <img
                            class="{{ $isLazyLoad ? 'lazyload' : '' }} height-447"
                ...
                @if ( isset($advertisementTwo[1]))
                    <a @if ($links[2]!='') target="_blank" href="{{ $links[2] }}" @endif class="col-lg-3 col-md-12 pr0">
                        <img
                            class="{{ $isLazyLoad ? 'lazyload' : '' }} height-447"
