@if ($velocityMetaData && $velocityMetaData->slider)
    <div class="slider-container">
        <slider-component direction="{{ core()->getCurrentLocale()->direction }}"
            ...
            @if(! empty($sliderData))
                <img class="col-12 p-0 banner-icon" src="{{ Storage::url($sliderData[0]['path']) }}" alt=""/>
            @else
                <img class="col-12 p-0 banner-icon" src="{{ asset('/themes/velocity/assets/images/banner.webp') }}" alt=""/>
            @endif
