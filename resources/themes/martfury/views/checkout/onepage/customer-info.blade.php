<form data-vv-scope="address-form">
    <div class="form-container" v-if="! this.new_billing_address">
        <div class="form-header mb-30">
            ...
            <a class="ps-btn" @click="newBillingAddress()">
        ...
        <div class="address-holder">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.billing[address_id]') ? 'has-error' : '']">
                <span
                    class="control-error"
    ...
    <div class="form-container row" v-if="this.new_billing_address">
        <div class="form-header col-12">
            <h3 class="mb-4">{{ __('shop::app.checkout.onepage.billing-address') }}</h3>
            @auth('customer')
                @if(count(auth('customer')->user()->addresses))
                    <a class="ps-btn" @click="backToSavedBillingAddress()">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[email]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[company_name]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[first_name]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[last_name]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-12" :class="[errors.has('address-form.billing[address1][]') ? 'has-error' : '']">
        ...
        @if (core()->getConfigData('customer.settings.address.street_lines') && core()->getConfigData('customer.settings.address.street_lines') > 1)
            <div class="control-group form-group" style="margin-top: -25px;">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[city]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[country]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[postcode]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[state]') ? 'has-error' : '']">
        ...
        <div class="control-group form-group col-md-6" :class="[errors.has('address-form.billing[phone]') ? 'has-error' : '']">
    ...
    @if ($cart->haveStockableItems())
        <div class="form-container" v-if="! address.billing.use_for_shipping && ! this.new_shipping_address">
            <div class="form-header mb-30">
                ...
                <a class="ps-btn" @click="newShippingAddress()">
                    {{ __('shop::app.checkout.onepage.new-address') }}
                </a>
            </div>
            ...
            <div class="address-holder">
                ...
                <div class="control-group form-group" :class="[errors.has('address-form.shipping[address_id]') ? 'has-error' : '']">
                    <span
                        class="control-error"
        ...
        <div class="form-container" v-if="! address.billing.use_for_shipping && this.new_shipping_address">
            <div class="form-header">
                <h3 class="mb-4">{{ __('shop::app.checkout.onepage.shipping-address') }}</h3>

                @auth('customer')
                    @if(count(auth('customer')->user()->addresses))
                        <a class="ps-btn" @click="backToSavedShippingAddress()">
                            {{ __('shop::app.checkout.onepage.back') }}
                        </a>
                    @endif
                @endauth
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[first_name]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[last_name]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[email]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[address1][]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[city]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[country]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[state]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[postcode]') ? 'has-error' : '']">
            ...
            <div class="control-group form-group" :class="[errors.has('address-form.shipping[phone]') ? 'has-error' : '']">
