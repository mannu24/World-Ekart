                        ...
                        <form
                            ...
                            <div class="form-group">
                                <div class="ps-checkbox d-md-inline">
                                    <input class="form-control" type="checkbox" id="close_rma" name="close_rma" v-validate="'required'" style="width:20% !important" />
                                    <label for="close_rma">
                                        {{ __('rma::app.shop.view-customer-rma.status-quotes') }}
                                        <span style="color:red;">*</span>
                                    </label>
                                </div>
                                <span class="control-error" v-if="errors.has('form-1.close_rma')">
                                    @{{ errors.first('form-1.close_rma') }}
                                </span>
                            </div>
                            <button type="submit" class="ps-btn" name="form-1">
                ...
                <div class="section-content">
                    <div>
                        ...
                        <form
                            ...
                            <div class="row col-lg-6 col-12 form-group" :class="[errors.has('form-2.message') ? 'has-error' : '']">
                                <textarea
                                    v-validate="'required'"
                                    class="form-control required" id="message" name="message"
                            ...
                            <div class="row col-12">
                                <button type="submit" class="ps-btn ps-btn--rounded btn-small" name="form-2">
