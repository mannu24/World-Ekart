...
@section('account-breadcrumb')
    <ul class="breadcrumb">
        <li><a href="/">Home</a></li>
        <li>Request New Order Return</li>
    </ul>
@endsection
...
<div class="col-lg-9">
    <div class="ps-section--account-setting">
        <div class="ps-section__content">
            <form method="POST" @submit.prevent="onSubmit" enctype="multipart/form-data" action="{{ route('rma.customers.store') }}" class="ps-block--address">
                @csrf()
                <figcaption class="d-flex justify-content-between mb-3">
                    Request New Order Return
                    <button type="submit" class="ps-btn btn-small" onClick="formValidation()">Create</button>
                </figcaption>
                    ...
                    <div class="sale-container">
                        <div class="sale-section">
                            <div class="sale-title">
                                <div class="section-title">Add Images to Review</div>
                            </div>
        ...
        <div class="sale-container">
            <div class="sale-section">
                <div class="row col-12 mx-0 px-0">
                    <input type="text" v-model="searchOrderValue" class="mb-4 col-lg-4 col-12 form-control" placeholder="{{ __('rma::app.shop.customer-rma-create.enter_order_id') }}" />
                    <button class="ps-btn ps-btn--rounded btn-small ps-btn--gray" @click="searchOrders($event)">
                        {{ __('rma::app.shop.customer-rma-create.search_order') }}
                    </button>
                </div>
                <div class="d-flex justify-content-between">
                    <div class="form-group d-inline" :class="[errors.has('order_id') ? 'has-error' : '']">
                        <label>
                    ...
                    <div class="form-group d-inline" v-if="resolutions != ''" :class="[errors.has('resolution') ? 'has-error' : '']">
                        <label>
                    ...
                    <div v-if="orderStatus" class="form-group d-inline" :class="[errors.has('order_status') ? 'has-error' : '']">
    
                        <label>
                            {{ __('rma::app.shop.customer-rma-create.order_status') }}
                        </label>
    
                        <select class="form-control w-auto" id="checkOrderStatus"  name="order_status" @change="checkOrderStatus($event)" v-validate="'required'" data-vv-as="&quot;{{ __('rma::app.shop.validation.order_status') }}&quot;">
                    ...
                    <div v-if="orderStatus == 0" class="form-group d-inline" :class="[errors.has('order_status') ? 'has-error' : '']">
                        ...
                        <table class="table">
                            ...
                            <tbody style="text-align: center;" v-if="orderItems.length != 0 && resolutions != null">
                                <tr v-for="(orderData,index) in orderItems">
                                    ...
                                    <td class="w-auto">
                                        <div class="form-group" :class="[errors.has('quantity[' + orderItems[index].id + ']') ? 'has-error' : '']">
                                            <select class="form-control" :name="'quantity[' + orderItems[index].id + ']'"
                                    ...
                                    <td class="w-auto">
                                        <div class="form-group" :class="[errors.has('rma_reason_id[' + orderItems[index].id + ']') ? 'has-error' : '']">
