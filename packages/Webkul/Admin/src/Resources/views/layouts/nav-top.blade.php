...
<div class="navbar-top">
    <div class="navbar-top-left">
        ...
        <div class="brand-logo mobile-hide">
            <a href="{{ route('admin.dashboard.index') }}" class="d-flex">
                ...
                @else
                <default-image light-theme-image-url="{{ asset('vendor/webkul/ui/assets/images/logo.png') }}" dark-theme-image-url="{{ asset('vendor/webkul/ui/assets/images/logo.png') }}"></default-image>
                @endif
            </a>
        </div>
    </div>
